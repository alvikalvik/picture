...
function filter(menuListSelector, portfolioWrapperSelector, noResultsSelector, activeClass, classesForFilter) {
  var menu = document.querySelector(menuListSelector);
  var portfolio = document.querySelector(portfolioWrapperSelector);
  var noResultsElem = document.querySelector(noResultsSelector);
  ...
  function hideAllItems() {
    ...
    try {
      for (var _iterator = menu.querySelectorAll('li')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    try {
      for (var _iterator2 = portfolio.querySelectorAll('div')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var _item = _step2.value;
        _item.style.display = 'none';

        _item.classList.remove('animated', 'fadeIn');
      }
    } catch (err) {
  ...
  function handleMenuItem(selector) {
    ...
    var worksToShow = portfolio.querySelectorAll(selector);
    menuItem.addEventListener('click', function (evt) {
      ...
      if (worksToShow.length > 0) {
        ...
        try {
          for (var _iterator3 = worksToShow[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var work = _step3.value;
            work.style.display = '';
  ...
  try {
    for (var _iterator4 = classesForFilter[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      var className = _step4.value;
      handleMenuItem(".".concat(className));
    }
  } catch (err) {
...
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services */ "./src/js/modules/services.js");
...
function forms() {
  ...
  var formWithFileSelector = '[data-form-with-file]';
  var inputsWithFile = document.querySelectorAll('[data-form-with-file] input[type="file"]');
  var message = {
    loading: 'Загрузка...',
  ...
  function clearInputs() {
    ...
    try {
      for (var _iterator2 = inputsWithFile[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  function initForms() {
    ...
    try {
        ...
        fileInput.addEventListener('input', function () {
          ...
          if (fileName.length > 10) {
            var _fileName$split = fileName.split('.'),
                ...
                pureName = _fileName$split2[0],
                extension = _fileName$split2[1];

            pureName = pureName.slice(0, 6) + '..';
            fileName = "".concat(pureName, ".").concat(extension);
          }
      ...
      for (var _iterator3 = inputsWithFile[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        _loop();
      }
    } catch (err) {
      _didIteratorError3 = true;
    ...
    try {
      var _loop2 = function _loop2() {
        ...
        item.addEventListener('submit', function (evt) {
          ...
          Object(_services__WEBPACK_IMPORTED_MODULE_14__["sendForm"])(submitUrl, formData).then(function (response) {
            ...
            currentMessage = "".concat(message.fail, ": ").concat(error);
      ...
      for (var _iterator4 = formsList[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        _loop2();
      }
    } catch (err) {
      _didIteratorError4 = true;
...
function modals() {
  var isShown = false;
  var allModalsSelector = '[data-modal]';

  function runModal(modalSelector, triggerSelector, closeSelector) {
    var delTrigger = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var modal = document.querySelector(modalSelector);
    var close = modal.querySelector(closeSelector);
    var triggers = document.querySelectorAll(triggerSelector);
    document.querySelectorAll(allModalsSelector).forEach(function (item) {
  ...
  function showModalAfterScroll(triggerSelector) {
    window.addEventListener('scroll', function scrollHandler() {
      ...
      var windowRelativeBottom = document.documentElement.getBoundingClientRect().bottom; // if user scrolled enough (< 50px to the end)
...
function pictureSize(selector) {
  var imgBlocks = document.querySelectorAll(selector);
  ...
  function showImg(block) {
    ...
    try {
      for (var _iterator = block.querySelectorAll('p:not(.sizes-hit)')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var item = _step.value;
        item.style.display = 'none';
      }
    } catch (err) {
  ...
  function hideImg(block) {
    ...
    try {
      for (var _iterator2 = block.querySelectorAll('p:not(.sizes-hit)')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  try {
    ...
    for (var _iterator3 = imgBlocks[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      _loop();
    }
  } catch (err) {
    _didIteratorError3 = true;
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services */ "./src/js/modules/services.js");
...
function showMoreStyles(triggerSelector, wrapperSelector) {
  ...
  function showMoreCards(url) {
    Object(_services__WEBPACK_IMPORTED_MODULE_9__["getResource"])(url).then(function (res) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
      ...
      errMessage.textContent = "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430 \u0434\u0430\u043D\u043D\u044B\u0445 \u0441 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 \u043D\u0435 \u0443\u0434\u0430\u043B\u0430\u0441\u044C. \u041E\u0448\u0438\u0431\u043A\u0430: ".concat(err);
...
function slider(sliderSelector, slidesSelector, direction, nextSelector, prevSelector) {
  ...
  function initSlider() {
    ...
    try {
      var next = slider.querySelector(nextSelector);
      var prev = slider.querySelector(prevSelector);
